  ...
  return (
    <div className="relative">
      ...
      {showMenu && (
        ...
        <Link to="/">
        <li className='text-slate-700 hover:underline selection:text-slate-900 block'>Home</li>
        </Link>
        <Link to="/about">
        <li className='text-slate-700 hover:underline selection:text-slate-900 block'>About</li>
        </Link>
        <Link to="/sign-in">
        <li className='text-slate-700 hover:underline selection:text-slate-900 block'>Sign In</li>
        </Link>
        <Link to="/sign-up">
